...
public class Question {
    ...
    // constructor chia theo level
    public Question(int id, String chapter, String question, String[] options, int answer,
                    String explanation, String image, String examId) {
        this.id = id;
        this.chapter = chapter;
        this.question = question;
        this.options = options;
    ...
    public boolean isFrequentlyWrong() {
        return isFrequentlyWrong;
    }

    public void setFrequentlyWrong(boolean frequentlyWrong) {
        this.isFrequentlyWrong = frequentlyWrong;
    }
